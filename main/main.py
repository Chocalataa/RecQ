...
if __name__ == '__main__':
    ...
    print 'd6. IRGAN         d7. SRGAN         d8. SRRL'
    ...
    algorthms = {'1':'UserKNN','2':'ItemKNN','3':'BasicMF','4':'SlopeOne','5':'SVD','6':'PMF',
                 ...
                 's7':'LOCABAL','s8':'SocialFD','s9':'TBPR','s10':'SEREC','s11':'TrustMF','a1':'CoFactor',
                 'a2':'CUNE_MF','a3':'CUNE_BPR','a4':'IF_BPR',
                 'd1':'APR','d2':'CDAE','d3':'DMF','d4':'NeuMF','d5':'CFGAN','d6':'IRGAN','d7':'SRGAN','d8':'SRRL',
